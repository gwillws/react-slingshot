    ...
    <div>
      ...
      <table>
        <tbody>
          <tr>
            <td>
              <label htmlFor='newMpg'>
                New Vehicle MPG
              </label>
            </td>
            <td>
              <FuelSavingsTextInput onChange={fuelSavingsKeypress} name='newMpg' value={appState.newMpg} />
            </td>
          </tr>
          <tr>
            <td>
              <label htmlFor='tradeMpg'>
                Trade-in MPG
              </label>
            </td>
            <td>
              <FuelSavingsTextInput onChange={fuelSavingsKeypress} name='tradeMpg' value={appState.tradeMpg} />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <FuelSavingsTextInput onChange={fuelSavingsKeypress} name='newPpg' value={appState.newPpg} />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <FuelSavingsTextInput onChange={fuelSavingsKeypress} name='tradePpg' value={appState.tradePpg} />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <FuelSavingsTextInput onChange={fuelSavingsKeypress} name='milesDriven' value={appState.milesDriven} /> miles per
